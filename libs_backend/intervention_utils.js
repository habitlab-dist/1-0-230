(function(){
  ...
  ref$ = require('libs_backend/db_utils'), setkey_dictdict = ref$.setkey_dictdict, getkey_dictdict = ref$.getkey_dictdict, getkey_dict = ref$.getkey_dict, getdict_for_key_dictdict = ref$.getdict_for_key_dictdict, getvar = ref$.getvar, setvar = ref$.setvar;
